...
class MonitoredProductDetails extends StatefulWidget {
  final String id;
  ...
  @override
  State<MonitoredProductDetails> createState() =>
      _MonitoredProductDetailsState();
}

class _MonitoredProductDetailsState extends State<MonitoredProductDetails> {
